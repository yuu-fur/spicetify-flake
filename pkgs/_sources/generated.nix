...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  defaultDynamicSrc = {
    ...
    version = "d463d7e7c5d4bef539f8af5c9c5a705cb95684e6";
    src = fetchgit {
      url = "https://github.com/JulienMaille/spicetify-dynamic-theme";
      rev = "d463d7e7c5d4bef539f8af5c9c5a705cb95684e6";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-39MgpRBfpVTiKoVCcfvdG7QZAlDKjVOFLAfL3BtP/iM=";
    };
    date = "2024-10-21";
  };
  draculaSrc = {
  ...
  starRatingsSrc = {
    ...
    version = "fbef6e1c39baa0913a4ad141719eada07144e14c";
    src = fetchgit {
      url = "https://github.com/brimell/spicetify-star-ratings";
      rev = "fbef6e1c39baa0913a4ad141719eada07144e14c";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-Ykn0JoqwSva1scBB+XB1pK6KfPM66p8fetSJppJZ5iQ=";
    };
    date = "2024-06-19";
  };
  startPageSrc = {
